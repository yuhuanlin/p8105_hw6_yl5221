...
As the boxplot shows, the first regression model lm(bwt ~ bhead + blength + wtgain) has the smallest rmse mean. Thus, we will choose the 1st regression model among three models.
```{r}
cv_df %>% 
  mutate(
